...
@section('title', 'Contact Language')

@section('page-breadcrumb')
<li><a href="#" title="">Contact Language</a></li>
<li><a href="#" title="">Contact Layout</a></li>
@endsection
    ...
    <div class="col-lg-8 col-12">
        ...
        <div class="uk-card uk-card-default uk-width-1-2@m card">
            <div class="card-body">
                ...
                <img alt="posted-image" src="{{ asset('layout/contact.png') }}">
                <img alt="posted-image" src="{{ asset('layout/contact2.png') }}">
                <img alt="posted-image" src="{{ asset('layout/contact3.png') }}">
            </div>
        </div>
        <form id="formBerita" action="{{ route('admin.upsert.contact', $id) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method("POST")
            <div class="uk-card uk-card-default uk-width-1-2@m card">
                <div class="card-body">
