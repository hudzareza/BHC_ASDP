...
@section('title', 'Promo Language')

@section('page-breadcrumb')
<li><a href="#" title="">Promo Language</a></li>
<li><a href="#" title="">Promo Layout</a></li>
@endsection
    ...
    <div class="col-lg-8 col-12">
        ...
        <div class="uk-card uk-card-default uk-width-1-2@m card">
            <div class="card-body">
                ...
                <img alt="posted-image" src="{{ asset('layout/promo2.png') }}">
                <img alt="posted-image" src="{{ asset('layout/promo.png') }}">
                <img alt="posted-image" src="{{ asset('layout/promo3.png') }}">
            </div>
        </div>
        <form id="formBerita" action="{{ route('admin.upsert.promo', $id) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method("POST")
            <div class="uk-card uk-card-default uk-width-1-2@m card">
                <div class="card-body">
