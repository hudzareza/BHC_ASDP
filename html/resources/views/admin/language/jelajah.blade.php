...
@section('title', 'Jelajah Language')

@section('page-breadcrumb')
<li><a href="#" title="">Jelajah Language</a></li>
<li><a href="#" title="">Jelajah Layout</a></li>
@endsection
    ...
    <div class="col-lg-8 col-12">
        ...
        <div class="uk-card uk-card-default uk-width-1-2@m card">
            <div class="card-body">
                ...
                <img alt="posted-image" src="{{ asset('layout/jelajah.png') }}">
            </div>
        </div>
        <form id="formBerita" action="{{ route('admin.upsert.jelajah', $id) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method("POST")
            <div class="uk-card uk-card-default uk-width-1-2@m card">
                <div class="card-body">
                    <h4>Div "Destinasi Lainnya" <span class="text-danger">(* harus diisi)</span></h4>
                    <fieldset class="uk-fieldset">
                        <div class="uk-margin">
                            <input class="uk-input" value="{{$jelajah->lainnya ?? ''}}" type="text" placeholder="" name="lainnya">
                        </div>
                    </fieldset>
