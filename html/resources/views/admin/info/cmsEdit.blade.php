...
@section('title', 'Edit Article Info')
...
<div class="row mb-2">
    ...
    <div class="col-4">
        <div class="input-group">
            <a href="{{ route('admin.list.artikel.info') }}" class="button uk-button-default ml-auto px-3 py-2">
...
<div class="row">
    <div class="col-lg-8 col-12">
        ...
        <form id="formBerita" action="{{ route('admin.update.artikel.info', encrypt($berita->id)) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method("PUT")
