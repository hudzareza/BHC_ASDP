...
<div class="row merged20 mb-4">
    <div class="col-lg-12">
        <div class="col-md-8">
        <form role="search" id="searchform" action="{{ route('admin.add.slide.event') }}" method="POST">
            @csrf
            @method("GET")
            <div class="row pencariansearch">
            <div class="col-md-10">
                <div class="form-group">
                    <input type="text" name="src" placeholder="pencarian berdasarkan sub title" class="form-control select2bs4" style="width: 100%;">
                </div>
            </div>
            <div class="col-md-2">
                    ...
                    <tr>
                        ...
                        <script>
                            ...
                            function data(id) {
                                ...
                                url: "{{ route('admin.banner.slideevent') }}",
                                success: function(response, status){
                                    if (status == 'success') {
                                    console.log(response);
                                    window.parent.location.href = "{{ route('admin.list.slide.event') }}";
                                    }
                                }
                                });
                            }
