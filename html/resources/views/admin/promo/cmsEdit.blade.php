...
@section('title', 'Edit Article Promo')
...
<div class="row">
    <div class="col-lg-8 col-12">
        ...
        <form id="formBerita" action="{{ route('admin.update.artikel.promo', encrypt($berita->id)) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method("PUT")
            ...
            <div class="uk-card uk-card-default uk-width-1-2@m card">
                <div class="card-body">
                    ...
                    <fieldset class="uk-fieldset">
                        <div class="uk-margin">
                            <input maxlength="75" id="textInput1" class="uk-input" value="{{$berita->title}}" type="text" placeholder="Ketikan Judul" name="title">
                        </div>
                        <div class="uk-margin">
