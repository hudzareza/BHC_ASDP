...
@section('title', 'Slide Tickets')

@section('page-breadcrumb')
<li><a href="{{ route('admin.promo.slide.list') }}" title="">Slide Tickets</a></li>
@endsection
    ...
    <div class="col-4">
        <div class="input-group">
            <button id="iframe-pick" onclick="openIframe()" type="button" class="button uk-button-default ml-auto px-3 py-2">
                <i class="icofont-plus"></i> <span class="d-none d-md-inline">Add Slide Promo</span>
            </button>
        </div>
    </div>
</div>
            ...
            <table id="lists" class="table table-default all-events table-striped table-responsive-lg">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                         <div class="button soft-danger"><a href="{{ route('admin.delete.slidepromo', encrypt($berita->id)) }}" onclick="return confirm('Are you Sure delete this article?')"><i class="icofont-trash"></i></a></div>        
                        </td>
                    </tr>
                    @empty
                    <tr>
...
<script>
    function openIframe(){
    var iframe = '<div class="container" id="con"><iframe class="responsive-iframe" id="iframeFoto" src="{{ route("admin.promo.slide.add") }}" allowfullscreen></iframe></div>';
        $("#iframe").html(iframe);
        $("#iframe").show(500);
        $('#iframe-pick').hide();
        $('#lists').hide();
