				...
				<div class="inner_k_e_1">
					...
					<nav aria-label="breadcrumb">
						<ol class="breadcrumbs">
							...
							<li class="breadcrumb-item"><img src="{{ asset('assets/images/arrow-right.png') }}"></li>
							<li class="breadcrumb-item active" aria-current="page">{{__('promo.breadcumb')}}</li>
						</ol>
					</nav>
				</div>
			</div>
				...
				<div class="row">
					...
					<div class="col-md-4">
						<aside class="content-side sticky-top">
							<div class="">
								<div class="card-side">
									<p class="title">{{__('promo.lainnya')}}</p>
									@foreach($beritas as $listp)
									<div class="mb-4">
										<div class="d-flex">
											<figure>
												<a href="{{ route('tiket.promo.main') }}/{{$listp->id}}/detail">
													<img src="{{ asset('images/article').'/'.$listp->photo }}">
												</a>
											</figure>
											<div class="content">
												<a href="{{ route('tiket.promo.main') }}/{{$listp->id}}/detail">
													<p class="title">{{$listp->title}}</p>
												</a>
											</div>
										</div>
									</div>
